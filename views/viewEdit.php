<div class="row">
	<div class="col-lg-10 col-md-10 mx-auto article">
		<form class="form" role="form" action="<?=htmlspecialchars($baseurl);?>Article/Edit" method="post">
			...
			<div class="form-actions">
				...
				<button type="submit" name="edit" class="btn btn-success">Modifier</button>
                	<a class="btn btn-primary" href="<?=htmlspecialchars($baseurl);?>List"<?= $article->getId(); ?>">Retour</a>
			</div>
		</form>
	</div>
</div>